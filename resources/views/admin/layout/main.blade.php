                    ...
                    <li class="dropdown pull-right dropdown-user" style="margin-top: -30px; margin-right: 20px;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                ...
                                <a href="{{route('admin.profile')}}" role="button" data-toggle="modal"><i class="fa fa-user"></i> User Profile</a>
                            </li>
                            <li class="divider"></li>
                            <li>
                ...
                <aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
                    ...
                    <nav id="primary-nav">
                        <ul>
                             ...
                             <li>
                                <a href="{{route('admin.index')}}" class="active"><i class="fa fa-fire"></i>Dashboard</a>
                            </li>        
                            <li>
                                <a href="#"><i class="fa fa-th-list"></i>Department</a>
                                <ul>
                                    <li>
                            ...
                            <li>
                                <a href="#"><i class="fa fa-th-list"></i>Doctors</a>
                                <ul>
                                    <li>
                                        <a href="{{route('admin.adddoctor')}}"><i class="fa fa-pencil"></i>Add New Doctor</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.doctorlist')}}"><i class="fa fa-file-text"></i>Doctor List</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{route('admin.addpatient')}}"><i class="fa fa-pencil"></i>Add Patient</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.patientlist')}}"><i class="fa fa-th"></i>Patient List</a>
                                    </li>
                                    
                                </ul>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-th-list"></i>Nurses</a>
                                <ul>
                                    <li>
                                        <a href="{{route('admin.addnurse')}}"><i class="fa fa-pencil"></i>Add Nurse</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.nurselist')}}"><i class="fa fa-th"></i>Nurse List</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{route('admin.addnotice')}}"><i class="fa fa-pencil"></i>Add Notice</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.noticelist')}}"><i class="fa fa-th"></i>Notice List</a>
                                    </li>
                                    
                                </ul>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-th-list"></i>Admins</a>
                                <ul>
                                    <li>
                                        <a href="{{route('admin.addadmin')}}"><i class="fa fa-pencil"></i>Add Admin</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.adminlist')}}"><i class="fa fa-th"></i>Admin List</a>
                                    </li>
                             ...
                             <li>
                                <a href="#"><i class="fa fa-th-list"></i>Services</a>
                                <ul>
                                    <li>
                                        <a href="{{route('admin.addservice')}}"><i class="fa fa-pencil"></i>Add Service</a>
                                    </li>
                                    <li>
                                        <a href="{{route('admin.servicelist')}}"><i class="fa fa-th"></i>Service List</a>
                                    </li>
                            ...
                            <li>
                                <a href="{{route('admin.profile')}}"><i class="fa fa-th-list"></i>Manage Profile</a>
                            </li>
                            <li>
                                <a href="{{route('admin.cngpassword')}}"><i class="fa fa-th-list"></i>Change Password</a>
                            </li>
