    ...
    <body>
        ...
        <div id="page-container">
            ...
            <header class="navbar navbar-inverse">
                ...
                <!-- Logo -->
                <a href="{{route('patient.index')}}" class="navbar-brand">U{{session('type')}}</a>
                    ...
                    <li class="dropdown pull-right dropdown-user" style="margin-top: -30px; margin-right: 20px;">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                ...
                                <a href="{{route('patient.profile')}}" role="button" data-toggle="modal"><i class="fa fa-user"></i> User Profile</a>
                            </li>
                            <li class="divider"></li>
                            <li>
            ...
            <div id="inner-container">
                ...
                <aside id="page-sidebar" class="collapse navbar-collapse navbar-main-collapse">
                    ...
                    <nav id="primary-nav">
                        <ul>
                             ...
                             <li>
                                <a href="{{route('patient.index')}}" class="active"><i class="fa fa-fire"></i>Dashboard</a>
                            </li>
                            <li>
                                <a href="#"><i class="fa fa-th-list"></i>Prescription</a>
                                <ul>
                                    <li>
                                        <a href="{{route('patient.prescriptionlist')}}"><i class="fa fa-th"></i>View Prescription</a>
                                    </li>
                            ...
                            <li>
                                <a href="#"><i class="fa fa-th-list"></i>Doctor</a>
                                <ul>
                                    <li>
                                        <a href="{{route('patient.doctorlist')}}"><i class="fa fa-th"></i>View Doctor List</a>
                                    </li>
                            ...
                            <li>
                                <a href="#"><i class="fa fa-th-list"></i>Nurse</a>
                                <ul>
                                    <li>
                                        <a href="{{route('patient.nurselist')}}"><i class="fa fa-th"></i>View Nurse List</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{route('patient.noticelist')}}"><i class="fa fa-th"></i>View Notice</a>
                                    </li>
                             ...
                             <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{route('patient.bloodlist')}}"><i class="fa fa-th"></i>Blood Doner List</a>
                                    </li>
                            ...
                            <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{route('patient.bedlist')}}"><i class="fa fa-envelope"></i>View Bed Allotment Lists</a>
                                    </li>
                             ...
                             <li>
                                ...
                                <ul>
                                    <li>
                                        <a href="{{route('patient.operationlist')}}"><i class="fa fa-envelope"></i>View Operation Lists</a>
                                    </li>
                            ...
                            <li>
                                <a href="{{route('patient.cngpassword')}}"><i class="fa fa-th-list"></i>Change Password</a>
                            </li>
                ...
                <div id="page-content">
                    ...
                    <ul id="nav-info" class="clearfix">
                        <li><a href="{{route('patient.index')}}"><i class="fa fa-home"></i></a></li>
