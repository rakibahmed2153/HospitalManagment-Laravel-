			...
			<div class="row">
					...
					<div class="row loaders_container">
						...
						<div class="col-md-3 loader_col">
							...
							<div class="loader" data-perc="0.95"><span>Passion</span>
                             <svg viewBox="0 0 100 100" style="display: block; width: 100%;"><path d="M 50,50 m 0,-48.5 a 48.5,48.5 0 1 1 0,97 a 48.5,48.5 0 1 1 0,-97" stroke="transparent" stroke-width="3" fill-opacity="0"></path><path d="M 50,50 m 0,-48.5 a 48.5,48.5 0 1 1 0,97 a 48.5,48.5 0 1 1 0,-97" stroke="rgb(32,211,74)" stroke-width="3" fill-opacity="0" style="stroke-dasharray: 304.844, 304.844; stroke-dashoffset: 15.2422;"></path>
                             </svg>
				...
				<div class="col-lg-4 boxes_col">
					...
					<div class="box">
						...
						<div class="working_hours_list working_hours">
							<ul>
			...
			<div class="row test_row">
				...
				<div class="col-lg-6 test_col">
					<div class="testimonial">
						...
						<div class="test_text">{{$u['review']}}</div>
						<div class="test_author d-flex flex-row align-items-center justify-content-start">
							<div class="test_author_image"><div><img src="{{asset('upload')}}/users/{{$u['username']}}.jpeg" alt=""></div></div>
							<div class="test_author_name">{{$u['name']}}, <span>{{$u['type']}}</span></div>
						</div>
					</div>
				</div>
				@endif
